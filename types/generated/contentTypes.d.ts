...
export interface ApiProdukProduk extends Schema.CollectionType {
  ...
  attributes: {
    ...
    terjual: Attribute.Integer;
    rating: Attribute.Integer;
    stock: Attribute.Integer;
    minPembelian: Attribute.Integer;
    ...
    stok: Attribute.Integer;
    nama_toko: Attribute.String;
