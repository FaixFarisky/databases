"use strict";(self.webpackChunkdatabase_uts=self.webpackChunkdatabase_uts||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>lt});var e=n(27279),C=n(27875),m=n(10701),P=n(48102),H=n(74758),g=n(93415),r=n(87006),M=n(36938),w=n(59082),D=n(26784),X=n(76827),V=n(98934),l=n.n(V),f=n(10131),T=n.n(f),b=n(6078),x=n.n(b),k=n(51943),z=n.n(k),F=n(61020),J=n(51447),G=n(70774),ge=n(38101),fe=n(93153),_=n(50086),Z=n(32370),Be=n(38566),Pe=n(70627),o=n.n(Pe),K=n(27523),he=n(47558),v=n(90635),$=n(72450);const ye=$.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`;function le({component:t,dzName:a,index:s,isActive:i,isInDevelopmentMode:u,onClick:d}){const{modifiedData:h,removeComponentFromDynamicZone:j}=(0,K.Z)(),{schema:{icon:L,displayName:R}}=l()(h,["components",t],{schema:{}}),y=c=>{c.stopPropagation(),j(a,s)};return e.createElement(Ie,{alignItems:"center",direction:"column",className:i?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:d,role:"tab",tabIndex:i?0:-1,cursor:"pointer","aria-selected":i,"aria-controls":`dz-${a}-panel-${s}`,id:`dz-${a}-tab-${s}`},e.createElement(re,{icon:L,isActive:i}),e.createElement(g.x,{marginTop:1,maxWidth:"100%"},e.createElement(Z.Z,{variant:"pi",fontWeight:"bold",ellipsis:!0},R)),u&&e.createElement(ve,{as:"button",onClick:y},e.createElement(ke.Z,null)))}le.defaultProps={component:null,isActive:!1,isInDevelopmentMode:!1,onClick(){}},le.propTypes={component:o().string,dzName:o().string.isRequired,index:o().number.isRequired,isActive:o().bool,isInDevelopmentMode:o().bool,onClick:o().func};const Fe=le,Ae=(0,$.ZP)(M.Z)`
  width: ${(0,r.Q1)(32)};
  height: ${(0,r.Q1)(32)};
  padding: ${(0,r.Q1)(9)};
...
`,Ue=(0,$.ZP)(m.k)`
  ...
  align-items: center;
`;function se({customRowComponent:t,components:a,addComponent:s,name:i,targetUid:u}){const{isInDevelopmentMode:d}=(0,K.Z)(),[h,j]=(0,e.useState)(0),{formatMessage:L}=(0,F.Z)(),R=c=>{h!==c&&j(c)},y=()=>{s(i)};return e.createElement(ye,{className:"dynamiczone-row",isFromDynamicZone:!0},e.createElement("td",{colSpan:12},e.createElement(Se,{paddingLeft:8},e.createElement(Oe,{gap:2},d&&e.createElement("button",{type:"button",onClick:y},e.createElement(Ue,{direction:"column",alignItems:"stretch",gap:1},e.createElement(Ae,null),e.createElement(Z.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600"},L({id:(0,v.Z)("button.component.add"),defaultMessage:"Add a component"})))),e.createElement(m.k,{role:"tablist",gap:2},a.map((c,p)=>e.createElement(Fe,{key:c,dzName:i,index:p,component:c,isActive:h===p,isInDevelopmentMode:d,onClick:()=>R(p)}))))),e.createElement(we,null,a.map((c,p)=>{const E={customRowComponent:t,component:c};return e.createElement(g.x,{id:`dz-${i}-panel-${p}`,role:"tabpanel",tabindex:0,"aria-labelledby":`dz-${i}-tab-${p}`,key:c,style:{display:h===p?"block":"none"}},e.createElement("table",null,e.createElement("tbody",null,e.createElement(Ee,{...E,isFromDynamicZone:!0,targetUid:u,key:c}))))}))))}se.defaultProps={addComponent(){},components:[],customRowComponent:null,name:null},se.propTypes={addComponent:o().func,components:o().instanceOf(Array),customRowComponent:o().func,name:o().string,targetUid:o().string.isRequired};const We=se,ze=(0,$.ZP)(g.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
